...
const Register = () => {
    ...
    const [num_ss, setNumSs] = useState("");
    ...
    <div className="flex justify-center p-10">
      <Form className="w-96">
        ...
        <Form.Group className="mb-3" controlId="formBasicFirstname">
          ...
          <Form.Control type="text" placeholder="Firstname" onChange={(event) => {
              setFirstname(event.target.value);
            }} />
        </Form.Group>
        <Form.Group className="mb-3" controlId="formBasicLastname">
          <Form.Label>Lastname</Form.Label>
          <Form.Control type="text" placeholder="Lastname" onChange={(event) => {
              setLastname(event.target.value);
            }} />
        </Form.Group>
        <Form.Group className="mb-3" controlId="formBasicSocialnumber">
          <Form.Label>Social number</Form.Label>
          <Form.Control type="text" placeholder="Social number" onChange={(event) => {
